...
<VirtualHost *:80>
    ...
    ServerName dev.activity66-1.itchaiyaphum.com
    ErrorLog "logs/dev.activity66-1.itchaiyaphum.com.com-error_log"
    CustomLog "logs/dev.activity66-1.itchaiyaphum.com-access_log" common
...
- https://github.com/itchaiyaphum/activity66-1
...
- ให้เพิ่มบันทัดนี้ "127.0.0.1 dev.activity66-1.itchaiyaphum.com"
...
- เปิด Web Browser และรัน url (http://dev.activity66-1.itchaiyaphum.com)
...
- กด build ที่ Job: "activity66-1.itchaiyaphum.com - deploy"
- เข้า Browser ไปที่ url (http://activity66-1.itchaiyaphum.com)
